...
function preload(){
  ...
  bullet_Img = loadImage("assets/bulletImage.png");
}
...
function setup() {
  ...
  bg = createSprite(displayWidth/2+195,displayHeight/2+150,20,20)
  bg.addImage(bgImg)
  bg.scale = 1.5
  ...
  heart1=createSprite(displayWidth+110,40,20,20);
  heart1.visible = true;
...
function draw() {
  ...
  if(keyWentDown("space"))
  {
    ...
    bullet.addImage("shootbullet", bullet_Img)
    bullet.scale = 0.2;
    bullet.velocityX=20
...
//displaing the score and remaining lives and BULLETS
  textSize(20);
  fill("white");
  text("Bullets= "+bullets,displayWidth+200,displayHeight/2-340);
  text("Score= "+score,displayWidth+200,displayHeight/2-310);
